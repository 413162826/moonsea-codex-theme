...
const wallpapers = [
  tideDragonRealm,
  {
    ...
    id: "moonlit-silent",
    name: "月海无声",
    description: "弯月、静海与低对比深蓝，适合保持安静、专注的氛围编程",
    file: "moonlit-silent.png",
    previewFile: "moonlit-silent.webp",
    previewPosition: "50% 50%",
    wallpaperPosition: "50% 50%",
    previewGradient:
      "radial-gradient(circle at 78% 18%, rgba(222, 238, 244, 0.24), transparent 31%), linear-gradient(135deg, rgba(5, 19, 31, 0.06), rgba(3, 12, 23, 0.5))",
    wallpaperGradient:
      "radial-gradient(circle at 78% 16%, oklch(92% 0.025 220 / 0.12), transparent 30%), linear-gradient(90deg, oklch(7% 0.03 245 / 0.48), transparent 48%, oklch(6% 0.025 250 / 0.24))",
    patch: {
      ...tideDragonRealm.patch,
      accent: "#5C7D93",
      surface: "#EDF2F4",
      ink: "#172731",
    },
    palette: {
      ...tideDragonRealm.palette,
      accent: "oklch(82% 0.075 220)",
      accentSoft: "oklch(70% 0.07 224 / 0.15)",
      accentHover: "oklch(75% 0.08 220 / 0.2)",
      accentActive: "oklch(69% 0.08 224 / 0.25)",
      wallpaperVignette:
        "radial-gradient(ellipse at 0 0, oklch(6% 0.025 250 / 0.76), transparent 24%)",
      wallpaperProtection:
        "linear-gradient(90deg, oklch(7% 0.03 248 / 0.54), oklch(9% 0.028 245 / 0.12) 48%, oklch(6% 0.025 252 / 0.28))",
      wallpaperFloor:
        "linear-gradient(0deg, oklch(6% 0.026 248 / 0.34), transparent 58%)",
    },
  },
  {
    id: "mint-academy",
