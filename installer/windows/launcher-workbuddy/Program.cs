...
namespace MoonseaWorkBuddyLauncher;
...
internal static class Program
{
    ...
    private static int Main(string[] args)
    {
        try
        {
            ...
            var launcherScript = Path.Combine(installRoot, "Start-Moonsea-WorkBuddy-Windows.ps1");
        ...
        {
            MessageBox(IntPtr.Zero, error.Message, "月海 WorkBuddy", ErrorIcon);
            return 1;
        }
    }
}
